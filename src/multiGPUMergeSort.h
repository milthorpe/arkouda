...
void mergeLocalPartitions_int32(void *device_buffers_ptr, size_t pivot, int devicesToMerge, const int *gpus, const int nGPUs, size_t num_fillers);
void mergeLocalPartitions_int64(void *device_buffers_ptr, size_t pivot, int devicesToMerge, const int *gpus, const int nGPUs, size_t num_fillers);
void mergeLocalPartitions_float(void *device_buffers_ptr, size_t pivot, int devicesToMerge, const int *gpus, const int nGPUs, size_t num_fillers);
void mergeLocalPartitions_double(void *device_buffers_ptr, size_t pivot, int devicesToMerge, const int *gpus, const int nGPUs, size_t num_fillers);
#endif
